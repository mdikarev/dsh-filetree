...
## Status vocabulary
<!-- draft | refining | absorbed (projects may add local labels; do not turn this into a task tracker) -->
...
| 4 | Delete files/folders via tree context menu | absorbed | p4-file-deletion-context-menu.md |
| --- | --- | --- | --- |